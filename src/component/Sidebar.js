...
function Sidebar(props){
    ...
    return(
        <>
        {/*SIDEBAR*/}
        <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{width: "20vw", height:"100vh"}}>
                    <a href="/portal" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">

                    <span className="fs-4">Hoşgeldiniz</span>
                    </a>
                    <hr/>
                    <ul className="nav nav-pills flex-column mb-auto">
                        ...
                        <li>
                            <Link className={`nav-link ${props.sifre_active} ${props.sifre_disable}`} 
                                    aria-current="page" 
                                    to={`${props.sifre_to}`}
                                    >
                                        Şifre Değiştir</Link>
